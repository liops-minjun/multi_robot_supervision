...
struct QUICConfig {
    ...
    std::string resumption_ticket_path{"/var/lib/robot_agent/quic_ticket"};
...
struct StorageConfig {
    std::string behavior_trees_path{"/var/lib/robot_agent/graphs"};
    std::string state_definitions_path{"/var/lib/robot_agent/state_definitions"};
    std::string state_persistence_path{"/var/lib/robot_agent/state"};
    std::string message_queue_path{"/var/lib/robot_agent/queue"};
    std::string agent_id_path{"/var/lib/robot_agent/agent_id"};  // Server-assigned ID storage
...
struct RosConfig {
    std::string node_name{"robot_agent"};
...
struct AgentConfig {
    ...
    std::string agent_name{"Robot Agent"};
