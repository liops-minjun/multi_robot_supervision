...
void TaskLogSender::send_log(TaskLogLevel level,
    ...
    switch (level) {
        case TaskLogLevel::DEBUG:
            ::robot_agent::executor::log.debug("[{}] {} - {}", component, task_id, message);
            break;
        case TaskLogLevel::INFO:
            ::robot_agent::executor::log.info("[{}] {} - {}", component, task_id, message);
            break;
        case TaskLogLevel::WARN:
            ::robot_agent::executor::log.warn("[{}] {} - {}", component, task_id, message);
            break;
        case TaskLogLevel::ERROR:
            ::robot_agent::executor::log.error("[{}] {} - {}", component, task_id, message);
            break;
    }
}
