...
// Fleet Agent - Tick-based architecture (refactored)
//
...
#include "fleet_agent/interfaces/transport.hpp"
#include "fleet_agent/interfaces/capability_scanner.hpp"
#include "fleet_agent/interfaces/action_executor.hpp"
...
/**
 * Agent - Tick-based fleet agent with multi-threaded ROS2 execution.
 *
 * Architecture:
 *   ┌─────────────────────────────────────────────────────┐
