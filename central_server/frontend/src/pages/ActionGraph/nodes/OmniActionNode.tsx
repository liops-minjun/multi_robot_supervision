...
const OmniActionNode = memo(({ data, selected }: NodeProps<OmniActionNodeData>) => {
  ...
  return (
    ...
    >
      ...
      <div className="relative px-3 py-3">
        ...
        <div className="space-y-2">
          ...
          {data.subtype === 'Branch' && (
            <div className="flex items-center gap-2">
              ...
              />
              <span className="text-[10px] text-muted">Condition</span>
            </div>
          )}
        </div>
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-end gap-2">
            <span className="text-[10px] text-muted">Exec Out</span>
            <Handle
              type="source"
          ...
          <div className="flex items-center justify-end gap-2">
            <span className="text-[10px] text-muted">On Error</span>
            <Handle
              type="source"
              position={Position.Right}
              id="error-out"
      ...
      <div className="px-3 py-1.5 bg-elevated border-t border-primary flex items-center justify-between">
        <span className="text-[9px] text-muted uppercase tracking-wider">Action</span>
